...
exec "Snippet do do |".st.et."|<CR>".st.et."<CR>end"
...
exec "Snippet for for ".st."element".et." in ".st."collection".et."<CR>".st."element".et.".".st.et."<CR>end"
...
exec "Snippet until until ".st."condition".et."<CR>".st.et."<CR>end"
...
exec "Snippet mapo map do |".st."element".et."|<CR>".st."element".et.".".st.et."<CR>end"
...
exec "Snippet map map { |".st."element".et."| ".st."element".et.".".st.et." }"

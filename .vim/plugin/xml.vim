...
" WrapTag -> Places an XML tag around a visual selection.            
...
" NewFileXML -> Inserts <?xml?> at top of new file.                  
...
" ParseTag2 -> Experimental function to replace ParseTag             
...
" DeleteTag -> Deletes surrounding tags from cursor.                 
" Modifies mark z
...
" VisualTag -> Selects Tag body in a visual selection.                
" Modifies mark z
...
" InsertGt -> close tags only if the cursor is in a HTML or XML context 
...
" InitEditFromJump -> Set some needed autocommands and syntax highlights for EditFromJump. 
...
" EditFromJump -> Jump to the end of the tag and continue editing. 

...
(defvar my-packages '(starter-kit starter-kit-bindings starter-kit-eshell starter-kit-lisp starter-kit-ruby autopair coffee-mode dired-single full-ack haml-mode mode-compile rect-mark rvm rinari ruby-electric sass-mode yasnippet-bundle yaml-mode)

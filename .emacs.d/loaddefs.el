...
;;;***

;;;### (autoloads (cheat) "cheat" "elpa-to-submit/cheat.el" (18863
;;;;;;  23108))
...
;;;;;;  "clojure-mode" "elpa-to-submit/clojure-mode.el" (18863 23108))
...
;;;;;;  "cperl-mode" "elpa-to-submit/cperl-mode.el" (18863 23108))
...
;;;***

;;;### (autoloads (cssh-mode) "cssh" "elpa-to-submit/cssh.el" (18863
;;;;;;  23108))
...
(custom-autoload (quote mode-compile-make-program) "mode-compile" t)
...
(custom-autoload (quote mode-compile-ignore-makefile-backups) "mode-compile" t)
...
(custom-autoload (quote mode-compile-make-options) "mode-compile" t)
...
(custom-autoload (quote mode-compile-prefered-default-makerule) "mode-compile" t)
...
(custom-autoload (quote mode-compile-ignore-makerule-regexp) "mode-compile" t)
...
(custom-autoload (quote mode-compile-save-all-p) "mode-compile" t)

(defvar mode-compile-always-save-buffer-p nil "\
*Non-nil means save the current buffer without asking
before launching compilation command.")

(custom-autoload (quote mode-compile-always-save-buffer-p) "mode-compile" t)

(defvar mode-compile-never-edit-command-p nil "\
*Non-nil means never ask to user to edit the compile command.")

(custom-autoload (quote mode-compile-never-edit-command-p) "mode-compile" t)
...
(custom-autoload (quote mode-compile-before-kill-hook) "mode-compile" t)

(defvar mode-compile-after-kill-hook nil "\
Hook to be run after killing compile command is executed
when `mode-compile-kill' is invoked.")

(custom-autoload (quote mode-compile-after-kill-hook) "mode-compile" t)
...
(custom-autoload (quote mode-compile-expert-p) "mode-compile" t)
...
(custom-autoload (quote mode-compile-reading-time) "mode-compile" t)
...
(custom-autoload (quote emacs-lisp-byte-compile-dir-interactive-p) "mode-compile" t)
...
;;;;;;  "elpa-to-submit/oddmuse.el" (18863 23109))
...
;;;***

;;;### (autoloads (ri) "ri" "elpa-to-submit/ri.el" (18863 23109))
